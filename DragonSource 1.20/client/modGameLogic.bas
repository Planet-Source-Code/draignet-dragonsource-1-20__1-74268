...
Dim i As Long
    ...
    If FileExist("GUI\Game.gif") Then frmMain.Picture = LoadPicture(App.Path & "\GUI\Game.gif")
    ...
    If FileExist("GUI\Game.jpg") Then frmMain.Picture = LoadPicture(App.Path & "\GUI\Game.jpg")
    ...
    If FileExist("GUI\Game.png") Then frmMain.Picture = LoadPicture(App.Path & "\GUI\Game.png")
    ...
    frmMain.picItems.Picture = LoadPicture(App.Path & "\GFX\items.bmp")
...
Dim rec_back As RECT
    ...
    Do While InGame
        ...
        If GetPlayerPOINTS(MyIndex) > 0 Then
            frmMain.cmdSTR.Visible = True
            frmMain.cmdDEF.Visible = True
            frmMain.cmdSpeed.Visible = True
            frmMain.cmdEnergy.Visible = True
        Else
            frmMain.cmdSTR.Visible = False
            frmMain.cmdDEF.Visible = False
            frmMain.cmdSpeed.Visible = False
            frmMain.cmdEnergy.Visible = False
        End If
    ...
    If GettingMap = False Then
        ...
        If GetTickCount > IT + 500 And frmMain.picInv3.Visible = True Then
            For Q = 0 To MAX_INV - 1
                Qq = Player(MyIndex).Inv(Q + 1).Num
               
                If frmMain.picInv(Q).Picture <> LoadPicture() Then
                    frmMain.picInv(Q).Picture = LoadPicture()
                Else
                    If Qq = 0 Then
                        frmMain.picInv(Q).Picture = LoadPicture()
                    Else
                        Call BitBlt(frmMain.picInv(Q).hDC, 0, 0, PIC_X, PIC_Y, frmMain.picItems.hDC, (Item(Qq).Pic - Int(Item(Qq).Pic / 6) * 6) * PIC_X, Int(Item(Qq).Pic / 6) * PIC_Y, SRCCOPY)
                    End If
                End If
            Next Q
        End If
    ...
    If ScreenMode = 0 Then
        ...
        frmMain.txtMyTextBox.Text = MyText
        
        If Len(MyText) > 4 Then
            frmMain.txtMyTextBox.SelStart = Len(frmMain.txtMyTextBox.Text) + 1
        End If
    ...
    End If
        ...
        Call DX.GetWindowRect(frmMain.picScreen.hWnd, rec_pos)
...
Public Sub EditorInit()
    SaveMap = Map
    InEditor = True
    frmMapEditor.Show vbModeless, frmMain
...
Dim i As Long
    ...
    frmMain.lstInv.Clear
    
    ' Show the inventory
    For i = 1 To MAX_INV
        If GetPlayerInvItemNum(MyIndex, i) > 0 And GetPlayerInvItemNum(MyIndex, i) <= MAX_ITEMS Then
            If Item(GetPlayerInvItemNum(MyIndex, i)).Type = ITEM_TYPE_CURRENCY Then
                frmMain.lstInv.AddItem i & ": " & Trim(Item(GetPlayerInvItemNum(MyIndex, i)).Name) & " (" & GetPlayerInvItemValue(MyIndex, i) & ")"
            Else
                ...
                If GetPlayerWeaponSlot(MyIndex) = i Or GetPlayerArmorSlot(MyIndex) = i Or GetPlayerHelmetSlot(MyIndex) = i Or GetPlayerShieldSlot(MyIndex) = i Then
                    frmMain.lstInv.AddItem i & ": " & Trim(Item(GetPlayerInvItemNum(MyIndex, i)).Name) & " (worn)"
                Else
                    frmMain.lstInv.AddItem i & ": " & Trim(Item(GetPlayerInvItemNum(MyIndex, i)).Name)
                End If
            End If
        Else
            frmMain.lstInv.AddItem "<free inventory slot>"
        End If
    Next i
    
    frmMain.lstInv.ListIndex = 0
End Sub
...
Dim d As Long
    ...
    For Index = 1 To MAX_INV
        If GetPlayerShieldSlot(MyIndex) <> Index Then frmMain.ShieldImage.Picture = LoadPicture()
        If GetPlayerWeaponSlot(MyIndex) <> Index Then frmMain.WeaponImage.Picture = LoadPicture()
        If GetPlayerHelmetSlot(MyIndex) <> Index Then frmMain.HelmetImage.Picture = LoadPicture()
        If GetPlayerArmorSlot(MyIndex) <> Index Then frmMain.ArmorImage.Picture = LoadPicture()
    Next Index
    
    For Index = 1 To MAX_INV
        If GetPlayerShieldSlot(MyIndex) = Index Then Call BitBlt(frmMain.ShieldImage.hDC, 0, 0, PIC_X, PIC_Y, frmMain.picItems.hDC, (Item(GetPlayerInvItemNum(MyIndex, Index)).Pic - Int(Item(GetPlayerInvItemNum(MyIndex, Index)).Pic / 6) * 6) * PIC_X, Int(Item(GetPlayerInvItemNum(MyIndex, Index)).Pic / 6) * PIC_Y, SRCCOPY)
        If GetPlayerWeaponSlot(MyIndex) = Index Then Call BitBlt(frmMain.WeaponImage.hDC, 0, 0, PIC_X, PIC_Y, frmMain.picItems.hDC, (Item(GetPlayerInvItemNum(MyIndex, Index)).Pic - Int(Item(GetPlayerInvItemNum(MyIndex, Index)).Pic / 6) * 6) * PIC_X, Int(Item(GetPlayerInvItemNum(MyIndex, Index)).Pic / 6) * PIC_Y, SRCCOPY)
        If GetPlayerHelmetSlot(MyIndex) = Index Then Call BitBlt(frmMain.HelmetImage.hDC, 0, 0, PIC_X, PIC_Y, frmMain.picItems.hDC, (Item(GetPlayerInvItemNum(MyIndex, Index)).Pic - Int(Item(GetPlayerInvItemNum(MyIndex, Index)).Pic / 6) * 6) * PIC_X, Int(Item(GetPlayerInvItemNum(MyIndex, Index)).Pic / 6) * PIC_Y, SRCCOPY)
        If GetPlayerArmorSlot(MyIndex) = Index Then Call BitBlt(frmMain.ArmorImage.hDC, 0, 0, PIC_X, PIC_Y, frmMain.picItems.hDC, (Item(GetPlayerInvItemNum(MyIndex, Index)).Pic - Int(Item(GetPlayerInvItemNum(MyIndex, Index)).Pic / 6) * 6) * PIC_X, Int(Item(GetPlayerInvItemNum(MyIndex, Index)).Pic / 6) * PIC_Y, SRCCOPY)
    Next Index
    
    frmMain.SelectedItem.Top = frmMain.picInv(frmMain.lstInv.ListIndex).Top - 1
    frmMain.SelectedItem.Left = frmMain.picInv(frmMain.lstInv.ListIndex).Left - 1
    
    frmMain.EquipS(0).Visible = False
    frmMain.EquipS(1).Visible = False
    frmMain.EquipS(2).Visible = False
    frmMain.EquipS(3).Visible = False
    ...
    For d = 0 To MAX_INV - 1
        If Player(MyIndex).Inv(d + 1).Num > 0 Then
            If Item(GetPlayerInvItemNum(MyIndex, d + 1)).Type <> ITEM_TYPE_CURRENCY Then
                'frmMain.descName.Caption = Trim(Item(GetPlayerInvItemNum(MyIndex, d + 1)).Name) & " (" & GetPlayerInvItemValue(MyIndex, d + 1) & ")"
            'Else
                If GetPlayerWeaponSlot(MyIndex) = d + 1 Then
                    'frmMain.picInv(d).ToolTipText = Trim(Item(GetPlayerInvItemNum(MyIndex, d + 1)).Name) & " (worn)"
                    frmMain.EquipS(0).Visible = True
                    frmMain.EquipS(0).Top = frmMain.picInv(d).Top - 2
                    frmMain.EquipS(0).Left = frmMain.picInv(d).Left - 2
                ElseIf GetPlayerArmorSlot(MyIndex) = d + 1 Then
                    'frmMain.picInv(d).ToolTipText = Trim(Item(GetPlayerInvItemNum(MyIndex, d + 1)).Name) & " (worn)"
                    frmMain.EquipS(1).Visible = True
                    frmMain.EquipS(1).Top = frmMain.picInv(d).Top - 2
                    frmMain.EquipS(1).Left = frmMain.picInv(d).Left - 2
                ElseIf GetPlayerHelmetSlot(MyIndex) = d + 1 Then
                    'frmMain.picInv(d).ToolTipText = Trim(Item(GetPlayerInvItemNum(MyIndex, d + 1)).Name) & " (worn)"
                    frmMain.EquipS(2).Visible = True
                    frmMain.EquipS(2).Top = frmMain.picInv(d).Top - 2
                    frmMain.EquipS(2).Left = frmMain.picInv(d).Left - 2
                ElseIf GetPlayerShieldSlot(MyIndex) = d + 1 Then
                    'frmMain.picInv(d).ToolTipText = Trim(Item(GetPlayerInvItemNum(MyIndex, d + 1)).Name) & " (worn)"
                    frmMain.EquipS(3).Visible = True
                    frmMain.EquipS(3).Top = frmMain.picInv(d).Top - 2
                    frmMain.EquipS(3).Left = frmMain.picInv(d).Left - 2
                Else
                    'frmMain.picInv(d).ToolTipText = Trim(Item(GetPlayerInvItemNum(MyIndex, d + 1)).Name)
                End If
            End If
        End If
    Next d
