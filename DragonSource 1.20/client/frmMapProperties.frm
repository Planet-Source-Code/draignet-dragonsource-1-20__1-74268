...
Begin VB.Form frmMapProperties 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "frmMapProperties.frx":1CCA
      ...
      TabCaption(1)   =   "NPC'S"
      TabPicture(1)   =   "frmMapProperties.frx":1CE6
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VB.ComboBox cmbMoral 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmMapProperties.frx":1D02
            Left            =   75
            List            =   "frmMapProperties.frx":1D0F
      ...
      Begin VB.ComboBox cmbNpc 
         ...
         Height          =   315
         Index           =   3
         ItemData        =   "frmMapProperties.frx":1D36
         Left            =   -74880
         List            =   "frmMapProperties.frx":1D38
         Style           =   2  'Dropdown List
         TabIndex        =   12
         Top             =   1320
         Width           =   4095
      ...
      Begin VB.ComboBox cmbNpc 
         ...
         Height          =   315
         Index           =   7
         ItemData        =   "frmMapProperties.frx":1D3A
         Left            =   -74880
         List            =   "frmMapProperties.frx":1D3C
         Style           =   2  'Dropdown List
         TabIndex        =   8
         Top             =   2760
         Width           =   4095
      ...
      Begin VB.ComboBox cmbNpc 
         ...
         Height          =   315
         Index           =   13
         ItemData        =   "frmMapProperties.frx":1D3E
         Left            =   -74880
         List            =   "frmMapProperties.frx":1D40
         Style           =   2  'Dropdown List
         TabIndex        =   2
         Top             =   4920
         Width           =   4095
...
Dim X As Long, Y As Long, i As Long
    ...
    lstMusic = Trim(Map.Music)
    lstMusic.Text = Trim(Map.Music)
